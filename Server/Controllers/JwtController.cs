...
namespace WebApiJwtAuthDemo.Controllers
{
    ...
    public class JwtController : Controller
    {
        ...
        public JwtController(IOptionsSnapshot<JwtIssuerOptions> jwtOptions, ILoggerFactory loggerFactory)
        {
        ...
        /// </summary>
        private static Task<ApplicationUser> GetClaimsIdentity(ApplicationUser user)
        {
            if (user.UserName == "AdminUser" &&
                user.Password == "IsBoss123")
            {
                user.Id = "1";
                user.Roles = new Role[] { new Role { Value = "Admin" } };
